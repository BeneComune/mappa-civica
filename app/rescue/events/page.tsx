...
export default function RescueEventsPage() {
  return (
    <div>
      ...
      <Faq>
        Il censimento nasce nel 2013 su 10 corsi d&apos;acqua; nel 2024 il Gruppo Comunale di
        Protezione Civile ne ha rilevati nuovamente 3 (Povoleit, Spia, sistema Cian/Cjasarile) dopo
        le allerte del novembre 2023 e la piena del 10 ottobre 2024. In questa visualizzazione,
        dove OpenStreetMap ha il corso d&apos;acqua (Rio Spia, Rio Ciasarile, Rio Bennata, e il rio
        senza nome presso Cao Malnisio) abbiamo usato il suo tracciato. Un ulteriore rio censito
        nel 2013 non compare in mappa perché privo di coordinate e di nome certo (foto datate
