...
// Badge/chip variant of FilterCheckboxGroup: same shared-filter behavior
// (checkboxes narrowing a single layer via one MapLibre filter), styled as
// icon pills instead of checkbox rows. All options start selected, matching
// the old app's default.
