...
export function addBikeInfraOverlay(map: Map): void {
  ...
  addBikeInfraPoints(map, "bike-parking", ["==", ["get", "class"], "bike_parking"], "#2f78c4")
  addBikeInfraPoints(map, "bike-rental", ["==", ["get", "class"], "bike_rental"], "#2b8a3e")
  addBikeInfraPoints(map, "bike-repair", ["==", ["get", "class"], "bike_repair"], "#7b2cbf")
  addBikeInfraPoints(map, "ebike-charging", ["==", ["get", "class"], "ebike_charging"], "#f59f00")
}
